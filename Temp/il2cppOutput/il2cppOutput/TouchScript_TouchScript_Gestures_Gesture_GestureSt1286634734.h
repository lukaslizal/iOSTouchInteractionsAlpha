...
struct  GestureState_t1286634734 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GestureState_t1286634734, ___value___1)); }
