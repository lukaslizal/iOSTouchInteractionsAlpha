...
struct  TimedSequence_1_t3109688313  : public Il2CppObject
{
public:
	// System.Collections.Generic.List`1<T> TouchScript.Utils.TimedSequence`1::points
	List_1_t1355284821 * ___points_0;
...
public:
	inline static int32_t get_offset_of_points_0() { return static_cast<int32_t>(offsetof(TimedSequence_1_t3109688313, ___points_0)); }
	inline List_1_t1355284821 * get_points_0() const { return ___points_0; }
	inline List_1_t1355284821 ** get_address_of_points_0() { return &___points_0; }
	inline void set_points_0(List_1_t1355284821 * value)
	{
		___points_0 = value;
		Il2CppCodeGenWriteBarrier(&___points_0, value);
	}

	inline static int32_t get_offset_of_timestamps_1() { return static_cast<int32_t>(offsetof(TimedSequence_1_t3109688313, ___timestamps_1)); }
